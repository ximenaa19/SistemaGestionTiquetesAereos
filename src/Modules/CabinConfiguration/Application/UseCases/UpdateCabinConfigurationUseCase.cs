...
public class UpdateCabinConfigurationUseCase
{
    ...
    public UpdateCabinConfigurationUseCase(ICabinConfigurationRepository repository, ICabinConfigurationValidator validator)
    {
    ...
    public async Task ExecuteAsync(
        ...
        string seatLetters)
    {
        var idVO = CabinConfigurationId.Create(id);
        ...
        await _validator.ValidateUniqueCabinTypeInAircraftAsync(aircraftIdVO, cabinTypeIdVO, idVO);
        ...
        await _validator.ValidateNoRowOverlapAsync(aircraftIdVO, startRowVO, endRowVO, idVO);

        var entity = CabinConfigurationAggregate.Create(
            idVO,
            aircraftIdVO,
            cabinTypeIdVO,
            startRowVO,
