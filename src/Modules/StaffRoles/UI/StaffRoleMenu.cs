...
public class StaffRoleMenu
{
    private readonly CreateStaffRoleUseCase _create;
    private readonly GetAllStaffRolesUseCase _getAll;
    private readonly GetStaffRoleByIdUseCase _getById;
    private readonly GetStaffRoleByNameUseCase _getByName;
    private readonly UpdateStaffRoleUseCase _update;
    private readonly DeleteStaffRoleUseCase _delete;

    public StaffRoleMenu(
        CreateStaffRoleUseCase create,
        GetAllStaffRolesUseCase getAll,
        GetStaffRoleByIdUseCase getById,
        GetStaffRoleByNameUseCase getByName,
        UpdateStaffRoleUseCase update,
        DeleteStaffRoleUseCase delete)
    {
        _create = create;
        _getAll = getAll;
        _getById = getById;
