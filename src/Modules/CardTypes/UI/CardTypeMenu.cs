...
{
    private readonly CreateCardTypeUseCase _create;
    private readonly GetAllCardTypesUseCase _getAll;
    private readonly GetCardTypeByIdUseCase _getById;
    private readonly GetCardTypeByNameUseCase _getByName;
    private readonly UpdateCardTypeUseCase _update;
    private readonly DeleteCardTypeUseCase _delete;

    public CardTypeMenu(
        CreateCardTypeUseCase create,
        GetAllCardTypesUseCase getAll,
        GetCardTypeByIdUseCase getById,
        GetCardTypeByNameUseCase getByName,
        UpdateCardTypeUseCase update,
        DeleteCardTypeUseCase delete)
    {
        _create = create;
        _getAll = getAll;
        _getById = getById;
