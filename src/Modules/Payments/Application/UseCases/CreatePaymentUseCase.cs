...
public class CreatePaymentUseCase
{
    ...
    public async Task ExecuteAsync(int reservationId, decimal amount, DateTime paidAt, int stateId, int methodId)
    {
        ...
        await _validator.ValidateNotOverpayAsync(reservationIdVO, amountVO, stateIdVO);

        var payment = Payment.CreateNew(reservationIdVO, amountVO, paidAtVO, stateIdVO, methodIdVO);
